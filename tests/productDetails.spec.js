...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    expect(typeof productDetails('Alcool gel', 'Máscara')).not.toBe(productDetails('Água', 'Sabão'));
    // expect(productDetails('Alcool gel')).toBe != productDetails('Mascara'));
    expect(productDetails('Alcool gel', 'Máscara')[0]).not.toBe(expect(productDetails('Alcool gel', 'Máscara')[1]));
